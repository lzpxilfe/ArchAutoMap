...
DEFAULT_BEFORE_OUTLINE_COLOR_HEX = "#E53935"  # Before 도면 전용 외곽선: 빨간색
DEFAULT_OUTLINE_WIDTH_MM = 0.6
DEFAULT_DPI = 300
DEFAULT_PREVIEW_DPI = 120
DEFAULT_TARGET_OCCUPANCY_RATIO = 0.60
DEFAULT_MIN_CONTEXT_BUFFER_M = 0   # 0 = 비활성 (기존 동작 그대로)
MAX_CONTEXT_BUFFER_M = 5000
